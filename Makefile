#
# Makefile for ut (Ուրանտիայի թղթեր)
# 
...
MISCFILES = tex/title.tex tex/paper-titles.tex tex/quiz.tex
...
# use the old TeX Live 2017, because with 2020 we get "\endcsname undefined" because of some conflict
export TEXDIR=/home/tigran/texlive/2017
export TEXMFLOCAL=/home/tigran/texlive/texmf-local
export TEXMFSYSVAR=$(TEXDIR)/texmf-var
export TEXMFSYSCONFIG=$(TEXDIR)/texmf-config
export TEXMFVAR=/home/tigran/.texlive2017/texmf-var
export TEXMFCONFIG=/home/tigran/.texlive2017/texmf-config
export TEXMFHOME=/home/tigran/texmf

export PATH=/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:$(TEXDIR)/bin/x86_64-linux:
